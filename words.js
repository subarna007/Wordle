// NOTE: If you have the official NYT list, replace these arrays with the full answer/allowed lists.
const ANSWER_WORDS = [
...
const EXTRA_GUESSES = [
  'about','other','which','their','there','would','could','house','place','after','again','small','right','think','three','great','where','never','under','while',
